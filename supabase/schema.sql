...
CREATE TABLE candidates (
    ...
    -- İlandan bağımsız, açıklanabilir CV profil kalitesi
    quality_score NUMERIC(5,2),
    quality_breakdown JSONB NOT NULL DEFAULT '{}'::jsonb,

    -- Ayni PDF/metnin ikinci kez aday olusturmasini engeller
...
CREATE UNIQUE INDEX idx_candidates_source_fingerprint ON candidates(source_fingerprint)
    WHERE source_fingerprint IS NOT NULL;

-- ============================================================
-- 4. İŞ İLANLARI VE İLAN-ADAY EŞLEŞTİRMELERİ
-- ============================================================
...
CREATE INDEX idx_matching_runs_job ON matching_runs(job_id, created_at DESC);
CREATE INDEX idx_job_matches_job ON job_candidate_matches(job_id, hybrid_score DESC);
CREATE INDEX idx_job_matches_candidate ON job_candidate_matches(candidate_id);

-- ============================================================
-- 5. MÜLAKATLAR (Interviews)
-- ============================================================
